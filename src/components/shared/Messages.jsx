...
export default function Messages({ userType, userId }) {
  ...
  useEffect(() => {
    ...
    // Set first conversation as selected by default if available
  ...
  return (
    <div>
      ...
      <div className="flex h-[calc(100vh-15rem)] bg-gray-800 rounded-lg overflow-hidden">
        ...
        <div className="w-80 flex-shrink-0 border-r border-gray-700">
          <div className="p-4 border-b border-gray-700">
            <div className="relative">
              <input
                type="text"
                className="w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    {getContactSpecialty(selectedConversation) && (
                      <p className="text-xs text-gray-400">{getContactSpecialty(selectedConversation)}</p>
                    )}
                  </div>
                </div>
